...
% Вводная практики: семинар N, без путей к файлам (код --- в PSAD, не в книге).
\newcommand{\PracticeIntro}[1]{%
  Раздел сопровождает семинар~#1: что измерять, что построить, какой вывод сделать.%
  Пошаговые вычисления и данные --- в материалах семинара курса (\PSADRepo{}).%
}
